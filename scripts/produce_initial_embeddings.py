"""
Embed all of the available papers initially
"""
...
def records_gen() -> Generator[Dict[str, Any], None, None]:
    ...
    """
    with Path(ARXIV_METADATA_SNAPSHOT_FILE).open(mode="r", encoding="utf-8") as f:
        for line in f:
...
def produce_embeddings_df() -> pd.DataFrame:
    ...
    embeddings_df["id"] = ids  # pylint: disable=unsupported-assignment-operation

    return embeddings_df


if __name__ == "__main__":
    produce_embeddings_df().to_feather(OUTPUT_FILE)
